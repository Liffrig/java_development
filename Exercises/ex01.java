...
public class ex01 {
    ...
    public static void main(String[] args) {
        ...
        //Zadanie 1 
        //Napisz program, który wczytuje trzy liczby, a,b i c, a następnie znajduje i drukuje środkową (co do wartości) z nich. 
        ...
        // Zadanie 2
        // Napisz program wczytujący cztery liczby całkowite i wypisujący różnicę między największą i najmniejszą z nich. 
        ...
        //Następnie zmienia wartości tych trzech zmiennych tak, aby w a znalazła się najmniejsza z wczytanych liczb, w b środkowa, a w c największa. 
        ...
        boolean exactlyOne = (x && (!y) && (!z)) || (y && (!x) && (!z)) || (z && (!y) && (!x)); // atLeastOne && !atLeastTwo
